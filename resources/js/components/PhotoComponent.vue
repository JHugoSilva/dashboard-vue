<script setup>
import { ref } from "vue";
import { watchEffect } from "@vue/compiler-core";
...
<template>
    <div style="width:350px;margin-top:100px;">
        <img :src="image" style="width:250px;margin-bottom:10px;"/>
        <cropper class="cropper" :src="img" :stencil-props="{ aspectRatio: 10 / 10 }" @change="change"></cropper>
